  ...
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
      ...
      >
        ...
        today, using only  <span className='font-extrabold text-white'> VR </span> devices you can easily explore the metaverse world you want, turn your dreams into reality.Let's
